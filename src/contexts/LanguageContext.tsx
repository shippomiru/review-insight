...
const translations = {
  zh: {
    ...
    'hero.title1': '洞察用户声音',
    'hero.title2': '提升应用体验',
    'hero.description': '分析 App Store 和 Google Play 的用户评论，发现用户喜欢、不满的功能，获取宝贵洞察，助力产品决策。',
    
    // App Analyzer
    'search.label': '应用名称',
    'search.placeholder': '例如：微信、TikTok',
    'search.button': '开始分析',
    'search.analyzing': '分析中...',
    'search.error.empty': '请输入应用名称',
    'search.error.general': '分析时出现错误，请稍后重试',
    'search.progress': '分析进度',
    'search.getting_data': '正在获取数据...',
    'search.wait_message': '分析过程通常需要 3-5 分钟，请耐心等待...',
    
    // Analysis Result
    'result.title': '{appName} 评价分析',
    'result.date_range': '分析时间范围', 
    'result.reviews_count': '分析评论数',
    ...
    'result.app_rating': '评分',
    'result.country': '地区',
    'result.likes': '用户喜欢的功能',
    'result.dislikes': '用户不满意的功能',
    'result.votes': '票',
    'result.feedback_examples': '用户怎么说：',
    ...
    'features.multiplatform.description': '支持分析 App Store 和 Google Play 的评论数据，获取全面的用户反馈。',
    'features.ranking.title': '功能排行榜',
    'features.ranking.description': '清晰展示用户喜欢、不满意的功能排行，帮助您识别产品优势和改进点。',
    'features.compliance.title': '合规数据处理',
    'features.compliance.description': '以合规方式处理用户评论，保护用户隐私和平台权益。',
    ...
    'how.step2.description': '我们将分析用户对产品的情感偏好和对功能的反馈，提取关键洞察。整个过程通常需要几分钟时间。',
    'how.step3.title': '获取洞察报告',
    'how.step3.description': '分析完成后，可以看到详细的报告，包括用户喜欢、不满意的功能排行榜，帮助您了解产品优势和改进机会。',
    ...
    'faq.q1.answer': '我们使用合规的方式从 App Store 和 Google Play 获取公开的用户评论数据，并确保符合平台规定。',
    'faq.q2.title': '数据更新频率如何？是否能分析最新评论？​',
    'faq.q2.answer': '我们的系统和最新的公开数据保持一致。免费版的分析包含最近100条用户反馈，以确保洞察的时效性。',
    'faq.q3.title': '分析一个应用需要多长时间？',
    'faq.q3.answer': '分析时间取决于评论数量和服务器负载。通常情况下，分析需要 3-5 分钟，过程中可以看到进度提示。',
    'faq.q4.title': '分析结果的准确性如何？',
    'faq.q4.answer': '我们使用先进的大语言模型技术分析评论，准确识别用户提到的功能和情感。虽然技术在不断进步，分析结果仍可能存在一定误差，建议综合判断使用。',
    ...
    'pricing.basic.feature1': '每天分析 3 个应用',
    'pricing.basic.feature2': '最近 100 条评论数据',
    ...
    'pricing.pro.feature1': '每天分析 50 个应用',
    ...
    'footer.terms': '使用条款',
    'footer.contact': '联系我们',
    'footer.contact.email': '邮箱: shipporun@gmail.com',
  ...
  en: {
    ...
    'search.placeholder': 'e.g., WeChat, TikTok',
    ...
    'search.getting_data': 'Retrieving data...',
    ...
    'features.compliance.description': 'Process user reviews in a compliant way to protect user privacy and platform rights.',
    ...
    'how.step2.description': 'We analyze user sentiment and mentioned features to extract key insights. The process typically takes a few minutes.',
    ...
    'faq.q1.answer': 'We use compliant methods to gather publicly available user review data from App Store and Google Play, strictly comply with platform regulations.',
    'faq.q2.title': 'How often is the data updated? Can it analyze the latest reviews?',
    'faq.q2.answer': 'Our system stays synchronized with the latest public data. The free version analyzes the most recent 100 user reviews to ensure up-to-date insights.',
    'faq.q3.title': 'How long does it take to analyze an app?',
    'faq.q3.answer': 'Analysis time depends on the number of reviews and server load. Typically, analyzing takes 3-5 minutes. You can see progress indicators during the analysis process.',
    'faq.q4.title': 'How accurate are the analysis results?',
    'faq.q4.answer': 'We use advanced Large Language Model to analyze reviews and accurately identify features and sentiments mentioned by users. While technology continues to improve, analysis results may still have some margin of error, so we recommend using your judgment alongside our insights.',
    ...
    'pricing.basic.feature1': '3 app analyses per day',
    'pricing.basic.feature2': 'Last 100 reviews',
    ...
    'pricing.pro.feature1': '50 app analyses per day',
    ...
    'footer.contact.email': 'Email: shipporun@gmail.com',
